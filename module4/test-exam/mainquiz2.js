...
var slice, yall, AD_BG_START, MetaNET_BgAds_Settings;
!function (n, t) {
    "use strict";
...
!function (n) {
    ...
    (function (r) {
        ...
        !function (i, r) {
            f = [];
            u = r(i);
            void 0 !== (e = "function" == typeof u ? u.apply(t, f) : u) && (n.exports = e)
        }(void 0 !== r ? r : this.window || this.global, function (n) {
            "use strict";

            function c() {
                for (var t, i, r = {}, n = 0; n < arguments.length; n++) {
                    t = arguments[n];
                    for (i in t) h.call(t, i) && (r[i] = t[i])
                }
                return r
            }
            ...
            function o(n, t, i) {
                ...
                var r, u;
                return function () {
                    var e = i || this, f = +new Date, o = arguments;
            ...
            var r, e, l = i(2), t = {}, u = {}, a = i(3), v = i(4), f, s, h;
            if ("undefined" != typeof window) return s = !!n.document.querySelector && !!n.addEventListener, h = Object.prototype.hasOwnProperty, u.destroy = function () {
                try {
                    document.querySelector(t.tocSelector).innerHTML = ""
                } catch (n) {
                    console.warn("Element not found: " + t.tocSelector)
                }
                document.removeEventListener("scroll", this._scrollListener, !1);
                document.removeEventListener("resize", this._scrollListener, !1);
                r && document.removeEventListener("click", this._clickListener, !1)
            }, u.init = function (n) {
                if (s && (t = c(l, n || {}), this.options = t, this.state = {}, t.scrollSmooth && (t.duration = t.scrollSmoothDuration, u.scrollSmooth = i(5).initSmoothScrolling(t)), r = a(t), e = v(t), this._buildHtml = r, this._parseContent = e, u.destroy(), null !== (f = e.selectHeadings(t.contentSelector, t.headingSelector)))) {
                    var h = e.nestHeadingsArray(f), y = h.nest;
                    return r.render(t.tocSelector, y), this._scrollListener = o(function (n) {
                        r.updateToc(f);
                        var i = n && n.target && n.target.scrollingElement && 0 === n.target.scrollingElement.scrollTop;
                        (n && (0 === n.eventPhase || null === n.currentTarget) || i) && (r.enableTocAnimation(), r.updateToc(f), t.scrollEndCallback && t.scrollEndCallback(n))
                    }, t.throttleTimeout), this._scrollListener(), document.addEventListener("scroll", this._scrollListener, !1), document.addEventListener("resize", this._scrollListener, !1), this._clickListener = o(function (n) {
                        t.scrollSmooth && r.disableTocAnimation(n);
                        r.updateToc(f)
                    }, t.throttleTimeout), document.addEventListener("click", this._clickListener, !1), this
                }
            }, u.refresh = function (n) {
                u.destroy();
                u.init(n || this.options)
            }, n.tocbot = u, u
        })
    }).call(t, i(1))
}, function (n) {
    ...
    n.exports = function (n) {
        function u(n, t) {
            var r = t.appendChild(h(n)), i;
            n.children.length && (i = f(n.isCollapsed), n.children.forEach(function (n) {
                u(n, i)
            }), r.appendChild(i))
        }
        ...
        function s(n, t) {
            ...
            return t.forEach(function (n) {
                u(n, r)
            }), i = document.querySelector(n), null !== i ? (i.firstChild && i.removeChild(i.firstChild), 0 === t.length ? i : i.appendChild(r)) : void 0
        }

        function h(r) {
            var f = document.createElement("li"), u = document.createElement("a");
            return n.listItemClass && f.setAttribute("class", n.listItemClass), n.onClick && (u.onclick = n.onClick), n.includeHtml && r.childNodes.length ? i.call(r.childNodes, function (n) {
                u.appendChild(n.cloneNode(!0))
            }) : u.textContent = r.textContent, u.setAttribute("href", "#" + r.id), u.setAttribute("class", n.linkClass + t + "node-name--" + r.nodeName + t + n.extraLinkClasses), f.appendChild(u), f
        }

        function f(i) {
            var u = document.createElement("ol"), r = n.listClass + t + n.extraListClasses;
            return i && (r += t + n.collapsibleClass, r += t + n.isCollapsedClass), u.setAttribute("class", r), u
        }

        function c() {
            var r = document.documentElement.scrollTop || o.scrollTop,
                i = document.querySelector(n.positionFixedSelector);
            "auto" === n.fixedSidebarOffset && (n.fixedSidebarOffset = document.querySelector(n.tocSelector).offsetTop);
            r > n.fixedSidebarOffset ? -1 === i.className.indexOf(n.positionFixedClass) && (i.className += t + n.positionFixedClass) : i.className = i.className.split(t + n.positionFixedClass).join("")
        }

        function l(u) {
            var w = document.documentElement.scrollTop || o.scrollTop, h, s, a, v, f, l, p;
            n.positionFixedSelector && c();
            s = u;
            r && null !== document.querySelector(n.tocSelector) && s.length > 0 && (y.call(s, function (t, i) {
                return t.offsetTop > w + n.headingsOffset + 10 ? (h = s[0 === i ? i : i - 1], !0) : i === s.length - 1 ? (h = s[s.length - 1], !0) : void 0
            }), a = document.querySelector(n.tocSelector).querySelectorAll("." + n.linkClass), i.call(a, function (i) {
                i.className = i.className.split(t + n.activeLinkClass).join("")
            }), v = document.querySelector(n.tocSelector).querySelectorAll("." + n.listItemClass), i.call(v, function (i) {
                i.className = i.className.split(t + n.activeListItemClass).join("")
            }), f = document.querySelector(n.tocSelector).querySelector("." + n.linkClass + ".node-name--" + h.nodeName + '[href="#' + h.id + '"]'), -1 === f.className.indexOf(n.activeLinkClass) && (f.className += t + n.activeLinkClass), l = f.parentNode, l && -1 === l.className.indexOf(n.activeListItemClass) && (l.className += t + n.activeListItemClass), p = document.querySelector(n.tocSelector).querySelectorAll("." + n.listClass + "." + n.collapsibleClass), i.call(p, function (i) {
                -1 === i.className.indexOf(n.isCollapsedClass) && (i.className += t + n.isCollapsedClass)
            }), f.nextSibling && -1 !== f.nextSibling.className.indexOf(n.isCollapsedClass) && (f.nextSibling.className = f.nextSibling.className.split(t + n.isCollapsedClass).join("")), e(f.parentNode.parentNode))
        }

        function e(i) {
            return -1 !== i.className.indexOf(n.collapsibleClass) && -1 !== i.className.indexOf(n.isCollapsedClass) ? (i.className = i.className.split(t + n.isCollapsedClass).join(""), e(i.parentNode.parentNode)) : i
        }

        function a(t) {
            var i = t.target || t.srcElement;
            "string" == typeof i.className && -1 !== i.className.indexOf(n.linkClass) && (r = !1)
        }
        ...
        var i = [].forEach, y = [].some, o = document.body, r = !0, t = " ";
        return {enableTocAnimation: v, disableTocAnimation: a, render: s, updateToc: l}
    }
}, function (n) {
    n.exports = function (n) {
        function t(n) {
        ...
        function i(n) {
            return +n.nodeName.split("H").join("")
        }
        ...
        function r(t) {
            ...
            return n.includeHtml && (r.childNodes = t.childNodes), r
        }

        function u(u, f) {
            for (var s = r(u), h = i(u), o = f, e = t(o), l = e ? e.headingLevel : 0, c = h - l; c > 0;) e = t(o), e && void 0 !== e.children && (o = e.children), c--;
            return h >= n.collapseDepth && (s.isCollapsed = !0), o.push(s), o
        }

        function f(t, i) {
            var r = i;
            n.ignoreSelector && (r = i.split(",").map(function (t) {
                return t.trim() + ":not(" + n.ignoreSelector + ")"
            }));
            try {
        ...
        function e(n) {
            return o.call(n, function (n, t) {
                return u(r(t), n.nest), n
            }, {nest: []})
        }

        var o = [].reduce;
        return {nestHeadingsArray: e, selectHeadings: f}
    }
}, function (n, t) {
    function i(n) {
        function u(n) {
            return "a" === n.tagName.toLowerCase() && (n.hash.length > 0 || "#" === n.href.charAt(n.href.length - 1)) && (t(n.href) === i || t(n.href) + "#" === i)
        }
        ...
        function f(n) {
            var t = document.getElementById(n.substring(1));
        ...
        var e = n.duration, i = location.hash ? t(location.href) : location.href;
        !function () {
            function t(t) {
                !u(t.target) || t.target.className.indexOf("no-smooth-scroll") > -1 || "#" === t.target.href.charAt(t.target.href.length - 2) && "!" === t.target.href.charAt(t.target.href.length - 1) || -1 === t.target.className.indexOf(n.linkClass) || r(t.target.hash, {
                    duration: e,
                    callback: function () {
                        f(t.target.hash)
                    }
    ...
    function r(n, t) {
        function f(n) {
            r = n - e;
            window.scrollTo(0, i.easing(r, o, u, h));
            r < h ? requestAnimationFrame(f) : c()
        }
        ...
        function l(n, t, i, r) {
            return (n /= r / 2) < 1 ? i / 2 * n * n + t : (n--, -i / 2 * (n * (n - 2) - 1) + t)
        }

        var e, r, o = window.pageYOffset,
            i = {duration: t.duration, offset: t.offset || 0, callback: t.callback, easing: t.easing || l},
            s = document.querySelector('[id="' + decodeURI(n).split("#").join("") + '"]'),
            u = "string" == typeof n ? i.offset + (n ? s && s.getBoundingClientRect().top || 0 : -(document.documentElement.scrollTop || document.body.scrollTop)) : n,
            h = "function" == typeof i.duration ? i.duration(u) : i.duration;
    ...
    t.initSmoothScrolling = i
}]);
yall = function () {
    "use strict";
    return function (n) {
        var r = (n = n || {}).lazyClass || "lazy", e = n.lazyBackgroundClass || "lazy-bg",
            c = "idleLoadTimeout" in n ? n.idleLoadTimeout : 200, l = n.observeChanges || !1, u = n.events || {},
            i = window, a = "requestIdleCallback", o = "IntersectionObserver", b = ["srcset", "src", "poster"], k = [],
            f = function (n, t) {
                return k.slice.call((t || document).querySelectorAll(n || "img." + r + ",video." + r + ",iframe." + r + ",." + e))
            }, s = function (t) {
                var u, r, o = t.parentNode, s, i;
                for (s in "PICTURE" == o.nodeName && (r = o), "VIDEO" == t.nodeName && (r = t), u = f("source", r)) y(u[s]);
                y(t);
                t.autoplay && t.load();
                i = t.classList;
                i.contains(e) && (i.remove(e), i.add(n.lazyBackgroundLoaded || "lazy-bg-loaded"))
            }, v = function (n) {
                for (var t in u) n.addEventListener(t, u[t].listener || u[t], u[t].options || void 0);
                h.observe(n)
            }, y = function (n) {
                b.forEach(function (t) {
                    t in n.dataset && i.requestAnimationFrame(function () {
                        n[t] = n.dataset[t]
                    })
                })
            }, t = f(), p, h, w;
        if (/baidu|(?:google|bing|yandex|duckduck)bot/i.test(navigator.userAgent)) for (p in t) s(t[p]); else if (o in i && o + "Entry" in i) {
            h = new i[o](function (n, u) {
                n.forEach(function (n) {
                    if (n.intersectionRatio) {
                        var f = n.target;
                        a in i && c ? i[a](function () {
                            s(f)
                        }, {timeout: c}) : s(f);
                        ...
                        (t = t.filter(function (n) {
                            return n != f
                        })).length || l || h.disconnect()
                    }
                })
            }, {rootMargin: ("threshold" in n ? n.threshold : 200) + "px 0%"});
            for (w in t) v(t[w]);
            l && new MutationObserver(function () {
                f().forEach(function (n) {
                    t.indexOf(n) < 0 && (t.push(n), v(n))
                })
            }).observe(f(n.observeRootSelector || "body")[0], n.mutationObserverOptions || {childList: !0, subtree: !0})
        }
    }
}();
$(function (n) {
    function it(n) {
        var t = n;
        return t = t.replace(/[Ã¡Ã áº£Ã£áº¡Ã¢áº¥áº§áº©áº«áº­Äƒáº¯áº±áº³áºµáº·]/ig, "a"), t = t.replace(/[Ä‘]/ig, "d"), t = t.replace(/[Ã©Ã¨áº»áº½áº¹Ãªáº¿á»á»ƒá»…á»‡]/ig, "e"), t = t.replace(/[Ã­Ã¬á»‰Ä©á»‹]/ig, "i"), t = t.replace(/[Ã³Ã²á»Ãµá»Ã´á»‘á»“á»•á»—á»™Æ¡á»›á»á»Ÿá»¡á»£]/ig, "o"), t = t.replace(/[Ã½á»³á»·á»¹á»µ]/ig, "y"), t = t.replace(/[ÃºÃ¹á»§Å©á»¥Æ°á»©á»«á»­á»¯á»±]/ig, "u"), t = t.replace(/[^a-z0-9-]/ig, ""), t = t.replace(/\s+/ig, ""), t = t.replace(/[-]+/ig, ""), t = t.replace(/^[-]+|[-]+$/ig, ""), t = t.toLowerCase(), t.trim()
    }

    var d, g, c, l, nt, a, v, o, y, p, e, s, rt, w, h, b, ut, ht;
    yall();
    var t = n("body"), et = n(window), k = n("#searchBox form #q");
    if (k.length > 0) try {
        k.autocomplete({
            delay: 500, source: function (t, i) {
                n.get("/s/", {q: t.term.replace(/^\s+|\s+$/gm, ""), datatype: "json"}, function (t) {
                    var r = [];
                    n.each(t.Taxonomies, function (n, t) {
                        var i = {
                            Name: t.Name,
                            Type: "Taxonomy",
                            Slug: t.Slug,
                            ThumbnailUrl: t.ThumbnailUrl,
                            TotalViews: "ChuyÃªn má»¥c"
                        };
                        r.push(i)
                    });
                    n.each(t.Posts, function (n, t) {
                        var i = {
                            Name: t.Name,
                            Type: "Posts",
                            Slug: t.Slug + "-" + t.PostId,
                            ThumbnailUrl: t.ThumbnailUrl,
                            TotalViews: t.TotalViews > 1 ? t.TotalViews.toLocaleString() : ""
                        };
                        r.push(i)
                    });
                    i(n.map(r, function (n) {
                        return {label: n.Name, value: n.Name, slug: n.Slug, image: n.ThumbnailUrl, view: n.TotalViews}
                    }))
                }, "json")
            }, minLength: 2, select: function (n, t) {
                window.location = "/" + t.item.slug
            }, open: function () {
                navigator.userAgent.match(/(iPod|iPhone|iPad)/) && n(".ui-autocomplete").off("menufocus hover mouseover")
            }
        }).autocomplete("instance")._renderItem = function (t, i) {
            return n("<li>").append("<a class='clearfix' href='/" + i.slug + "'><span class='imgSearch'><img src='" + i.image + "'/><\/span><span class='titleSearch'>" + i.label + "<\/span><span class='viewSearch'>" + i.view.toLocaleString() + "<\/span><\/a>").appendTo(t)
        }
    } catch (ot) {
        console && n.isFunction(console.log) && console.log(ot.message)
    }
    if (/android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(navigator.userAgent)) {
        n("#searchBox form").append("<a class='iconClear'><\/a>");
        n("#searchBox #q").keyup(function () {
            var t = n(this);
            n(".iconClear").toggle(Boolean(t.val()))
        });
        n(".iconClear").hide(n("#q").val());
        n(".iconClear").click(function () {
            n("#q").val("").focus();
            n(this).hide()
        });
        n("#searchBox #q").on("focus click", function () {
            n("#q").val().length > 0 && n(".iconClear").css("display", "inline")
        })
    }
    n(".ListNews .viewmore, .pagination .viewmore").click(function (t) {
        var i = n(this), r;
        i.addClass("loading");
        t.preventDefault();
        r = n(this).attr("data-ajax");
        typeof r != "undefined" && n.ajax({
            url: r, type: "GET", dataType: "html", success: function (t) {
                var r = n(t);
                if (r.attr("data-loaded") == "true") {
                    typeof slug != "undefined" || typeof search != "undefined" ? n(".viewmore").closest("ul").prev().find("ul").append(r.html()) : n(".listview>ul").append(r.html());
                    i.removeClass("loading");
                    n(".pagination a[rel=prev]").addClass("hide");
                    setTimeout(function () {
                        window.dispatchEvent(new Event("resize"))
                    }, 1e3);
                    var u = r.attr("data-nextAjax"), e = r.attr("data-next"), f = r.attr("data-nextUrl");
                    typeof f != "undefined" && typeof u != "undefined" && (i.attr("data-ajax", u), i.attr("href", f));
                    e == "False" && i.addClass("hide")
                }
            }, failure: function (n) {
                console.log("fail", n)
            }
    ...
    n(".navigation>li a[href='" + location.pathname + "']:not([href='/'])").parent().addClass("active");
    n(".breadcrumbs .breadcrumb a[href]:not([href='/'])").each(function () {
        n(".navigation>li a[href='" + n(this).attr("href") + "']").parent().addClass("active")
    });
    n("a[data-href]").click(function (t) {
        n(this).attr("data-target") == "_blank" ? window.open(n(this).attr("data-href")) : location.href = n(this).attr("data-href");
        t.preventDefault()
    });
    n.get("/account/navigation", function (t) {
        n("#header .topnav").html(t);
        n(".topnav>.user-info>.user-name").length > 0 && n.getScript("/so.ashx")
    });
    n("a[data-uid]").click(function () {
        var t = parseInt(n(this).attr("data-uid"));
        t && t > 0 && (location.href = "/users/" + n(this).attr("data-uid"))
    });
    n("div[data-ajax]").each(function () {
        var t = n(this), i = t.attr("data-ajax");
        n.get(i, function (i) {
            n(i).first().is("[data-loaded]") && t.replaceWith(i)
        })
    });
    n(".navbox").length > 0 && (d = n('<a class="toggle menu"><\/a>').appendTo("#header"), d.click(function () {
        t.toggleClass("showmenu")
    }));
    g = n('<a class="toggle search"><\/a>').appendTo("#header");
    c = n("#searchBox #q");
    g.on("click", function (i) {
        if (t.toggleClass("showsearch"), t.hasClass("showsearch") && (c.focus(), /iPhone|iPad/ig.test(navigator.userAgent))) {
            var r = n("<input type='text' class='shide'/>");
            r.prependTo("#searchBox").focus();
            setTimeout(function () {
                c.focus();
                r.remove()
            }, 1)
    ...
    if (l = n("<div id='overlay' class='overlay'><\/div>").appendTo("body"), n(".theme.post.two").length > 0 && (nt = window.innerWidth, nt >= 728 && (a = n(".toc").clone(), a != null && (n(".tocbox .sticky").html(a), n(".content-detail.textview .toc").css("display", "none")))), typeof n.fn.stick_in_parent == "function") {
        var i = n(".leftbar"), r = n(".sidebar"), u = n(".leftbar.sidenav"), f = n(".three .sidebar,.two .sidebar"),
            tt = function () {
                var t = window.innerWidth, e;
                u.length > 0 && u.has(".sticky") && n(".theme.post.three").length > 0 && (t >= 728 ? (u.css("height", u.parent().height()), u.find(".sticky").stick_in_parent()) : (u.css("height", ""), u.find(".sticky").trigger("sticky_kit:detach"), console.log("$leftThre.sticky_kit:detach")));
                i.length > 0 && i.has(".sticky") && n(".theme.post.three").length < 1 && (t >= 1320 ? (i.css("height", i.parent().height()), i.find(".sticky").stick_in_parent()) : (i.css("height", ""), i.find(".sticky").trigger("sticky_kit:detach")));
                r.length > 0 && r.has(".sticky") && n(".theme.post.three, .theme.post.two").length < 1 && (t >= 728 ? (r.css("height", n(".content").height()), r.find(".sticky").stick_in_parent()) : (r.css("height", ""), r.find(".sticky").trigger("sticky_kit:detach")));
                f.length > 0 && f.has(".sticky") && n(".theme.post.three ,.theme.post.two").length > 0 && (t >= 1320 ? (f.css("height", f.parent().height()), f.find(".sticky").stick_in_parent(), console.log("$sidebarThre.sticky_kit:stick_in_parent")) : (f.css("height", ""), f.find(".sticky").trigger("sticky_kit:detach")));
                n(".theme.post.two").length > 0 && (e = n(".tocbox"), t >= 728 ? (e.css("height", r.parent().height() - 32), e.find(".sticky").stick_in_parent(), console.log("toc-stick")) : (e.css("height", ""), e.find(".sticky").trigger("sticky_kit:detach")))
            };
        setTimeout(function () {
            et.resize(tt);
            tt()
    ...
    n(".postpage").length > 0 && (v = parseInt(n("[data-type][data-id]").attr("data-id")), typeof n.fn.starrr == "function" && n(".rating[data-rating]").starrr({
        rating: n(".rating").attr("data-rating"),
        change: function (t, i) {
            if (parseInt(i) > 0) {
                var r = n(this);
                n.post("/service/rate", {postid: v, value: i});
                r.replaceWith("CÃ¡m Æ¡n báº¡n Ä‘Ã£ Ä‘Ã¡nh giÃ¡")
            }
        }
    }), n.post("/service/track", {
        postid: v,
        type: "Views"
    }), o = n(".textview pre"), o.length > 0 && (o.addClass("prettyprint"), function (n, t, i) {
        var r, u = n.getElementsByTagName(t)[0];
        n.getElementById(i) || (r = n.createElement(t), r.id = i, r.src = "/scripts/prettify/run_prettify.js?skin=atelier-seaside-light", u.parentNode.insertBefore(r, u))
    }(document, "script", "prettify"), n.ajaxSetup({cache: !0}), n.getScript("/scripts/clipboard.min.js", function () {
        var i = 0, t;
        o.each(function () {
            var r = n(this), t = r.attr("id"), u, f;
            typeof t == "undefined" && (t = "pre" + i++, r.attr("id", t));
            u = n("<a class='btn-copy' title='Nháº¥n Ä‘á»ƒ sao chÃ©p'><\/a>");
            u.attr("data-clipboard-target", "#" + t);
            f = n('<div class="codebar"><\/div>');
            f.append(u);
            r.before(f)
        });
        t = new ClipboardJS(".btn-copy");
        t.on("success", function (n) {
            console.log("Action:", n.action);
            console.log("Text:", n.text);
            console.log("Trigger:", n.trigger);
            n.trigger.className = "btn-copy btn-copied";
            window.setTimeout(function () {
                n.trigger.className = "btn-copy"
            }, 2e3);
            n.clearSelection()
        });
    ...
    }), n.ajaxSetup({cache: !1})), n(".postpage .toc h2").click(function () {
        n(".postpage .toc").toggleClass("tochidden")
    }));
    n(".profilepage #avatar").click(function () {
        n("#dialogbox").show()
    });
    n("body").append("<a id='scrolltop'><\/a>");
    n("#scrolltop").click(function (t) {
        n("html, body").animate({scrollTop: 0}, 1e3);
        t.preventDefault()
    });
    y = n(window).scrollTop();
    p = function () {
        var t = n("#sideboxholder");
        n(window).width() < 375 && t.length <= 0 ? (n(".navbox.sidenav").after("<div id='sideboxholder'><\/div>"), n(".navbox.sidenav").appendTo("body")) : n(window).width() >= 375 && t.length > 0 && t.replaceWith(n("body .navbox.sidenav"))
    };
    p();
    n(window).resize(p);
    n('a[href^="#"]').on("click", function (t) {
        t.preventDefault();
        var i = this.hash, r = n(i);
        r.length > 0 && n("html, body").stop().animate({scrollTop: r.offset().top}, 1e3, "swing", function () {
            window.location.hash = i
        })
    });
    if (n(window).scroll(function () {
        var i = n(window).scrollTop();
        i > 500 ? t.addClass("upscroll") : t.removeClass("upscroll");
        y > i || !t.hasClass("showmenu");
        y = i
    }), typeof ga != "undefined" && n(".breadcrumbs span>a[href!='/']").length > 0 && setTimeout(function () {
        var t = "";
        n(".breadcrumbs span>a[href!='/']").each(function () {
            t += n.trim(n(this).text() + "") + ">"
        });
        console.log("names", t);
        ga("send", "event", "Categories", t, location.href)
    }, 1e3), n(".sidenav.toc .toc-head").append('<span class="toggle-list"><\/span>'), n(".toggle-list").click(function (n) {
        t.toggleClass("close-leftbar").removeClass("open-leftbar");
        n.preventDefault()
    }), n(".sidenav.toc .toc-navbar").length > 0 && (n(".toc-navbar a[href*='" + location.pathname + "']").parents("li.collapse").addClass("show") && n(".sidenav.toc a[href*='" + location.pathname + "']").addClass("active"), e = n(".toc-navbar"), s = n(".toc-navbar a.active"), s.length > 0 && s.has("ul") && (rt = e.scrollTop() + s.position().top - e.position().top - e.height() / 2, e.animate({scrollTop: rt}))), n(".sidenav.toc").length > 0) {
        w = function () {
            var t, i, r;
            n(".toc-navbar li:not(.notfound)").removeClass("hide show");
            h.hide();
            n(".toc-navbar a[href*='" + location.pathname + "']").parents("li.collapse").addClass("show") && n(".sidenav.toc a[href*='" + location.pathname + "']").addClass("active");
            t = n(".toc-navbar");
            i = n(".toc-navbar .collapse.show a.active");
            i.length > 0 && i.has("ul") && (r = t.scrollTop() + i.position().top - t.position().top - t.height() / 2, t.animate({scrollTop: r}))
        };
        n(".sidenav.toc .toc-head").append('<span class="toggle-search"><\/span><input type="text" name="q" id="fil" placeholder="TÃ¬m bÃ i" x-webkit-speech="">');
        n(".toggle-search").click(function () {
            n(".leftbar").toggleClass("filter");
            n(".leftbar").hasClass("filter") ? setTimeout(function () {
                n("#fil").focus()
            }, 500) : (n(".leftbar .toc-head #fil").val(""), w())
        });
        n(".toc-navbar li a").each(function () {
            var t = n(this).text();
            n(this).attr("data-title", it(t))
        });
        h = n("<li  class='notfound' >KhÃ´ng tÃ¬m tháº¥y<\/li>").hide().appendTo(".toc-navbar");
        n(".leftbar .toc-head #fil").on("keyup", function () {
            var r = n(this), t = it(r.val()), i;
            t != "" && t.length > 0 ? (n(".toc-navbar li:not(.notfound)").removeClass("show").addClass("hide"), i = n(".toc-navbar li:not(.notfound) a[data-title*='" + t + "']"), i.parents(".toc-navbar li:not(.notfound)").removeClass("hide").addClass("show"), n(".toc-navbar li.show:not(.notfound)").length < 1 ? h.show() : h.hide()) : w()
        });
        n(".toc-navbar>li.collapse a,.toc-navbar>li.collapse .icon-collapse").click(function () {
            var i = n(".toc-navbar"), t = n(this).parent();
            if (t.has("ul") && (t.toggleClass("show"), t.find("li").removeClass("hide"), t.hasClass("show") && t.parents(".leftbar").length > 0)) {
                var r = i.position().top, u = i.scrollTop(), f = t.position().top - r + u;
                i.animate({scrollTop: f}, 1e3)
            }
        })
    }
    if (b = function () {
    ...
    }(), n(".three .sidenav.toc").length > 0) {
        ut = n('<a class="toggle-leftbar"><\/a>').appendTo("body");

        function st() {
            function n() {
                t.removeClass("open-leftbar");
                /iPhone|iPad/ig.test(navigator.userAgent) && b(!1, ".toc-navbar")
            }

            var i = document.querySelector(".overlay");
            ut.click(function () {
                t.removeClass("close-leftbar");
                t.addClass("open-leftbar");
                /iPhone|iPad/ig.test(navigator.userAgent) && (b(!0, ".toc-navbar"), i.removeEventListener("click", n), i.addEventListener("click", n))
            });
    ...
    l.on("click touchstart", function (n) {
        t.removeClass("close-leftbar open-leftbar showmenu showsearch");
        document.activeElement.blur();
        n.preventDefault()
    });
    if (n(".content-detail.textview .toc li").each(function (t) {
        t >= 10 && n(this).addClass("hide")
    }), n(".content-detail.textview .toc li").length > 10 && (ht = n('<a class="viewmore-li"><span title="Xem thÃªm">Xem thÃªm<\/span><\/a>').appendTo(".content-detail .toc"), n(".viewmore-li").click(function () {
        n(".content-detail.textview .toc li").removeClass("hide");
        n(this).parent().removeClass("tochidden");
        n(this).css("display", "none")
    })), n(".textview .slider").length > 0) {
        var ct = n('<a class="next-slider">').appendTo(".slider"),
            lt = n('<a class="back-slider hide">').appendTo(".slider"), ft = n(".slider-wrapper").width() * .9;
        n(".next-slider").click(function () {
            var t = n(this).parent().find(".slider-wrapper"), i = n(this), r = n(this).parent().find(".back-slider");
            r.removeClass("hide");
            t.animate({scrollLeft: ft + t.prop("scrollLeft")}, 400, function () {
                t.prop("scrollWidth") - t.prop("scrollLeft") < t.outerWidth() + 15 ? i.addClass("hide") : i.removeClass("hide")
            })
        });
        n(".back-slider").click(function () {
            var t = n(this).parent().find(".slider-wrapper"), r = n(this), i = n(this).parent().find(".next-slider");
            i.removeClass("hide");
            t.animate({scrollLeft: t.prop("scrollLeft") - ft}, 400, function () {
                t.prop("scrollLeft") == 0 && (r.addClass("hide"), i.removeClass("hide"))
            })
        })
    }
    if (n(".theme.post.two").length > 0 && window.innerWidth >= 728) {
        n(window).on("scroll", function () {
            var t = n(".tocbox .toc");
            n(".tocbox").each(function () {
                setTimeout(function () {
                    if (n(".toc-list-item").hasClass("is-active-li")) {
                        t.on("scroll mousedown wheel DOMMouseScroll mousewheel keyup touchmove", function () {
                            t.stop()
                        });
                        t.animate({scrollTop: n(".toc li.is-active-li").position().top - 45}, 50)
                    } else if (n(window).scrollTop() == 0) {
                        t.on("scroll mousedown wheel DOMMouseScroll mousewheel keyup touchmove", function () {
                            t.stop()
                        });
                        t.animate({scrollTop: 0}, 10)
                    } else {
                        t.on("scroll mousedown wheel DOMMouseScroll mousewheel keyup touchmove", function () {
                            t.stop()
                        });
                        t.animate({scrollTop: 0}, 100)
                    }
                }, 2e3)
            })
        });
        tocbot.init({tocSelector: ".tocbox .toc", contentSelector: ".post-detail", headingSelector: "h1, h2, h3"})
    }
    "serviceWorker" in navigator && navigator.serviceWorker.register("/sw.js")
});
location.href.indexOf("ads=0") < 0 && $(".fb-comments,.fb-page").length > 0 && function (n, t, i) {
    var r, u = n.getElementsByTagName(t)[0];
    n.getElementById(i) || (r = n.createElement(t), r.id = i, r.src = "//connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v3.3&appId=265611626917890", u.parentNode.insertBefore(r, u))
}(document, "script", "facebook-jssdk");
$(function (n) {
    var s, e;
    n(".btn.reset-quiz").on("click", function () {
        location.href = location.href
    });
    n(".item-question.item-choices .list-item,.item-question.item-checkboxes .list-item").on("click", function () {
        n(".item-question .list-item :not(:selected),.item-question .list-item :not(:checked)").parents(".list-item").removeClass("selected");
        n(".item-question .list-item :selected,.item-question .list-item :checked").parents(".list-item").addClass("selected")
    });
    var r = 1, f = n(".quiz-main").attr("data-quiztype"), o = n(".item-question"),
        u = n(".quiz-main .quiz-section").length;
    if (n(".theme.quiztwo").length > 0 && (n(".quiz-main .quiz-section").addClass("hide"), n(".quiz-main .quiz-section:nth-child(1)").removeClass("hide"), n(".quiz-section:not(.hide)").find(".item-question").hasClass("item-checkboxes") && f == "Graded" && (n(".next-quiz").addClass("hide"), n(".confirm-quiz").removeClass("hide").addClass("disabled")), n(".quiz-section input").change(function () {
        var t = n(this);
        t.parents(".quiz-main").attr("data-quiztype") == "Graded" && (t.parents("div").hasClass("item-choices") && (n(".item-choices .selected input[data-status='1']").parents("li").addClass("true"), n(".item-choices .selected input[data-status='0']").parents("li").addClass("false"), n(".item-choices .list-item input[data-status='1']").parents("li").addClass("true"), n(".next-quiz").removeClass("disabled"), n(".quiz-section").addClass("noevent"), n(".selected").each(function () {
            var t = n(this);
            t.hasClass("false") && t.parents(".item-choices").addClass("wrong").parents(".quiz-section").find(".section-note").removeClass("hide")
        })), t.parents("div").hasClass("item-checkboxes") && (n(".quiz-section:not(.hide) input:checkbox:enabled:checked").length > 0 ? (n(".confirm-quiz").removeClass("hide disabled"), n(".check-quiz").removeClass("disabled")) : n(".confirm-quiz").addClass("disabled")));
        t.parents(".quiz-main").attr("data-quiztype") == "Outcome" && (t.parents("div").hasClass("item-checkboxes") && (n(".quiz-section:not(.hide) input:checkbox:enabled:checked").length > 0 ? n(".next-quiz").removeClass("disabled") : n(".next-quiz").addClass("disabled")), t.parents("div").hasClass("item-choices") && (n(".next-quiz").removeClass("disabled"), n(".check-quiz").removeClass("disabled")))
    }), n(".total-question").text("Số câu hỏi: 1/" + u + "")), n(".confirm-quiz").click(function () {
        n(".quiz-section").addClass("noevent");
        n(this).addClass("disabled hide");
        n(".next-quiz").removeClass("disabled hide");
        r == u && (n(".next-quiz").addClass("disabled hide"), n(".check-quiz").removeClass("hide"));
        n(".item-checkboxes .selected input[data-status='1']").parents("li").addClass("true");
        n(".item-checkboxes .selected input[data-status='0']").parents("li").addClass("false");
        n(".item-checkboxes .list-item input[data-status='1']").parents("li").addClass("true");
        n(".quiz-section input[type=checkbox]").each(function () {
            var t = n(this);
            (t.attr("data-status") == "1" && this.checked == !1 || t.attr("data-status") == "0" && this.checked == !0) && t.parents(".item-checkboxes").addClass("wrong").parents(".quiz-section").find(".section-note").removeClass("hide")
        });
        n(".check-quiz").removeClass("disabled")
    }), s = function () {
        var t = n(".item-question.yes").length + 1;
        n(".total-question").text("Số câu hỏi: " + t + "/" + u + "");
        n(".confirm-quiz, .section-note").addClass("hide");
        n(".item-checkboxes").removeClass("wrong");
        n(".quiz-section").removeClass("true false noevent");
        n(".list-item").removeClass("true");
        n(".next-quiz, .check-quiz").addClass("disabled");
        r <= u && (n(".quiz-main .quiz-section").addClass("hide"), n(".quiz-main .quiz-section:nth-child(" + r + ")").removeClass("hide"), n(".quiz-section:not(.hide)").find(".item-question").hasClass("item-checkboxes") && f == "Graded" && (n(".next-quiz").addClass("hide"), n(".confirm-quiz").removeClass("hide").addClass("disabled")));
        r == u && (n(".next-quiz").addClass("hide"), n(".check-quiz").removeClass("hide"), n(".quiz-section:not(.hide)").find(".item-question").hasClass("item-checkboxes") && f == "Graded" && n(".check-quiz").addClass("hide"))
    }, n(".next-quiz").click(function () {
        r = r + 1;
        s()
    }), n(".quiz-section input").change(function () {
        var t = n(this), i;
        t.parents(".list-item").addClass("selected");
        t.parents(".item-question .selected").length > 0 ? t.parents(".item-question").addClass("yes") : t.parents(".item-question").removeClass("yes");
        i = n(".quiz-section").find(".yes").length;
        i == u ? n(".check-quiz").removeClass("disabled") : (n(".note-quiz").addClass("hide"), n(".check-quiz").addClass("disabled"))
    }), n(".quiz-section").length > 0) {
        var c = n(".quiz-section").length, h = 0, t = 0, i = [];
        n(".check-quiz").click(function () {
            var u, e, r;
            if (n(".total-question").addClass("hide"), n(".theme.quiztwo").length > 0 && (n(".quiz-main .quiz-section").addClass("hide"), n(".confirm-quiz").addClass("hide")), n(".quiz-section").addClass("noevent"), u = 0, e = 0, o.hasClass("item-choices") && (u = n(".item-choices .selected input[data-status='1']").length), o.hasClass("item-checkboxes") && (n(".quiz-section input[type=checkbox]").each(function () {
                var t = n(this);
                (t.attr("data-status") == "1" && this.checked == !1 || t.attr("data-status") == "0" && this.checked == !0) && t.parents(".item-checkboxes").addClass("wrong")
            }), e = n(".item-checkboxes:not(.wrong)").length), h = u + e, n(".selected input").each(function () {
                t = t + parseFloat(n(this).attr("data-point"))
            }), t > 0) {
                f == "Outcome" ? (s(), n(".reset-quiz, .share-quiz").removeClass("hide")) : f == "Graded" && (r = "<span>Bạn đã trả lời đúng được " + h + "/" + c + " câu hỏi.<\/span><span> Số điểm bạn đạt được: " + t + " điểm.<\/span>", n(".quiz-result").append(r), s(), n(".selected input[data-status='1']").parents("li").addClass("true"), n(".selected input[data-status='0']").parents("li").addClass("false"), n(".list-item input[data-status='1']").parents("li").addClass("true"), n(".quiz-result, .reset-quiz, .share-quiz").removeClass("hide"), n(".selected").each(function () {
                    var t = n(this);
                    t.hasClass("false") && t.parents(".quiz-section").find(".section-note").removeClass("hide")
                }));

                function s() {
                    if (n(".item-checkpoint").each(function () {
                        i.push(n(this).attr("data-point"))
                    }), i != null && i != "") if (i = i.map(Number), i.includes(t) && t >= 0) n(".item-checkpoint[data-point='" + t + "']").removeClass("hide").parent().removeClass("hide"); else {
                        var u = i.filter(function (n) {
                            return n < t
                        }), r = Math.max.apply(Math, u);
                        console.log("found " + r);
                        n(".item-checkpoint[data-point='" + r + "']").removeClass("hide").parent().removeClass("hide")
                    }
                }
            } else r = "<span>Rất tiếc bạn chưa có câu trả lời đúng nào! Hãy thử lại...<\/span>", n(".quiz-result").append(r), n(".quiz-result, .reset-quiz, .section-note, .share-quiz").removeClass("hide");
            n(this).addClass("hide")
        });
        e = typeof canonical == "string" ? canonical : location.protocol + "//" + location.hostname + location.pathname;
        n(".share-quiz").click(function () {
            var i = parseInt(n(".theme.quiz .post-detail .rating").attr("data-id")), r = i + "|" + t,
                u = window.btoa(r), f = e + "?s=" + u, h = n(".quiz-result span:first-child").text(),
                o = n(".item-checkpoint:not(.hide) .quiz-check-review-desc.textview").text(),
                s = n(".item-checkpoint:not(.hide) img").attr("src");
            typeof s != "undefined" ? FB.ui({method: "share", href: f, quote: o}, function () {
            }) : l()
        });

        function l() {
            var t = n(".quiz-result span:first-child").text(),
                i = n(".item-checkpoint:not(.hide) .quiz-check-review-desc.textview").text();
            window.open("https://www.facebook.com/sharer/sharer.php?u=" + e + "&quote=" + i + "\n" + t + "")
        }
    }
});
$(function () {
    if ($(".sharebox .more-share,.sharebox .zalo-share,.sharebox .twitter-share,.sharebox .fb-share").length != 0) {
        var i = "579745863508352884", n = $("body"), r = $("link[rel=canonical]").attr("href"),
            ...
            f = "";
        /android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(navigator.userAgent) || (u = '<div id="qrcode" class="hide" ><center><img alt="MÃ£ QR Code" src="https://chart.apis.google.com/chart?cht=qr&amp;chs=100x100&amp;chld=L|0&amp;chl=' + encodeURIComponent(t + (t.indexOf("?") > 0 ? "&" : "?") + "utm_source=desktop&utm_medium=qrcode&utm_campaign=share") + '"/><\/center><p>Báº¡n cÃ³ thá»ƒ dÃ¹ng á»©ng dá»¥ng Ä‘á»c <a href="//tip.down.vn/huong-dan-su-dung-qr-code-tren-dien-thoai-150" target="_blank">QR Code<\/a> trÃªn Ä‘iá»‡n thoáº¡i Ä‘á»ƒ má»Ÿ Ä‘Æ°á»ng dáº«n nÃ y<br><a href="//tip.down.vn/huong-dan-su-dung-qr-code-tren-dien-thoai-150" target="_blank">Xem hÆ°á»›ng dáº«n táº¡i Ä‘Ã¢y<\/a>.<\/p><\/div>', f = '<a class="qrcode-share" title="Sá»­ dá»¥ng á»©ng dá»¥ng quÃ©t QR Code Ä‘á»ƒ má»Ÿ trÃªn Ä‘iá»‡n thoáº¡i"><span class="icon-share icon-qrcode"><\/span><i>QuÃ©t báº±ng  QR Code<\/i><\/a>', $(".sharebox .qrcode-share").removeClass("hide"));
        var e = $("<div class='overlay-share'><\/div>").appendTo("body"),
            o = $("<div class='toggle-share' title='Chia sáº»'><\/div>").appendTo("body"),
            s = $('<div class="dialog-share"><div class="share-title">Chia sáº»<\/div><a class="fb-share" title="Chia sáº» Facebook"><span class="icon-share icon-fb"><\/span><i>Chia sáº» Facebook<\/i><\/a><a class="zalo-share zalo-share-button" title="Chia sáº» Zalo"><span class="icon-share icon-zalo "><\/span><i>Chia sáº» Zalo<\/i><\/a><a class="twitter-share" title="Chia sáº» qua Twitter"><span class="icon-share icon-twitter"><\/span><i>Chia sáº» Twitter<\/i><\/a>' + f + "" + u + '<div class="close-box-share">ÄÃ³ng<\/div><\/div>').appendTo("body");
        if ($(".more-share , .toggle-share").click(function () {
            n.toggleClass("share")
    ...
    t.prototype.getDotCount = function () {
        ...
        if (n.options.infinite === !0) if (n.slideCount <= n.options.slidesToShow) ++t; else for (; i < n.slideCount;) ++t, i = r + n.options.slidesToScroll, r += n.options.slidesToScroll <= n.options.slidesToShow ? n.options.slidesToScroll : n.options.slidesToShow; else if (n.options.centerMode === !0) t = n.slideCount; else if (n.options.asNavFor) for (; i < n.slideCount;) ++t, i = r + n.options.slidesToScroll, r += n.options.slidesToScroll <= n.options.slidesToShow ? n.options.slidesToScroll : n.options.slidesToShow; else t = 1 + Math.ceil((n.slideCount - n.options.slidesToShow) / n.options.slidesToScroll);
        return t - 1
    };
    ...
    t.prototype.initArrowEvents = function () {
        var n = this;
        n.options.arrows === !0 && n.slideCount > n.options.slidesToShow && (n.$prevArrow.off("click.slick").on("click.slick", {message: "previous"}, n.changeSlide), n.$nextArrow.off("click.slick").on("click.slick", {message: "next"}, n.changeSlide), n.options.accessibility === !0 && (n.$prevArrow.on("keydown.slick", n.keyHandler), n.$nextArrow.on("keydown.slick", n.keyHandler)))
    };
    t.prototype.initDotEvents = function () {
        var t = this;
        t.options.dots === !0 && t.slideCount > t.options.slidesToShow && (n("li", t.$dots).on("click.slick", {message: "index"}, t.changeSlide), t.options.accessibility === !0 && t.$dots.on("keydown.slick", t.keyHandler));
    ...
    t.prototype.lazyLoad = function () {
        ...
        var u, f, i, r, t = this;
        if (t.options.centerMode === !0 ? t.options.infinite === !0 ? (i = t.currentSlide + (t.options.slidesToShow / 2 + 1), r = i + t.options.slidesToShow + 2) : (i = Math.max(0, t.currentSlide - (t.options.slidesToShow / 2 + 1)), r = 2 + (t.options.slidesToShow / 2 + 1) + t.currentSlide) : (i = t.options.infinite ? t.options.slidesToShow + t.currentSlide : t.currentSlide, r = Math.ceil(i + t.options.slidesToShow), t.options.fade === !0 && (i > 0 && i--, r <= t.slideCount && r++)), u = t.$slider.find(".slick-slide").slice(i, r), "anticipated" === t.options.lazyLoad) for (var o = i - 1, s = r, h = t.$slider.find(".slick-slide"), c = 0; c < t.options.slidesToScroll; c++) o < 0 && (o = t.slideCount - 1), u = u.add(h.eq(o)), u = u.add(h.eq(s)), o--, s++;
        e(u);
    ...
    n.fn.slick = function () {
        for (var u, i = this, r = arguments[0], f = Array.prototype.slice.call(arguments, 1), e = i.length, n = 0; n < e; n++) if ("object" == typeof r || "undefined" == typeof r ? i[n].slick = new t(i[n], r) : u = i[n].slick[r].apply(i[n].slick, f), "undefined" != typeof u) return u;
        return i
    }
});
...
MetaNET_BgAds2 = function (n, t) {
    ...
    if (!($(window).width() < 800) && !($(window).height() < 500)) {
        ...
        t = '<div id="ouibounce-modal"><div class="underlay"><\/div><div class="modal"><div class="modal-body"><div id="adsoutbounce" data-realclickzone="403"><\/div><\/div><\/div><\/div>';
        $("body").append(t);
